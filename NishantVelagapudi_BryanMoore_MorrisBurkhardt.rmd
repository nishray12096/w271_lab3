...
We will build a vector autoregressive (VAR) model to forecast four time series. Neither the name, nor the units of measure are given for the time series. We will therefore have to rely exclusively on statistical metrics, tests and graphical analysis to specify the order of the VAR model and to measure the model fit. We will also discuss possible enhancments of the model that might provide a better fit.
