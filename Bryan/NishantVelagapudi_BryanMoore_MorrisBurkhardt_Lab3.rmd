...
```
We can clearly see that none of the four time series are stationary. There does not appear to be an obvious seasonal trend within any of the four time series. We need to atempt to stationarize our time series via differencing.  There also appears to be high correlation between the four time series.

<Include scatterplotMatrix / correlation matrix?>
...
#### Differencing the series to impose stationarity
```{r}
