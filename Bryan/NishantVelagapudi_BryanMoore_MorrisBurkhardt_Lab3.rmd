...
q2_ts_series4_train_for_mv <- window(q2_ts_series4_train, start=1947.1)
#mv_ts_stationary <- cbind.data.frame(diff_1_q2_ts_series1_train,diff_1_q2_ts_series2_train,diff_1_q2_ts_series3_train,q2_ts_series4_train_for_mv)
mv_ts_stationary <- data.frame(Y=as.matrix(diff_1_q2_ts_series1_train,diff_1_q2_ts_series2_train,diff_1_q2_ts_series3_train,q2_ts_series4_train_for_mv), data=time(diff_1_q2_ts_series1_train))
VARselect(mv_ts_stationary, lag.max=10, type="both")
```
Per VARselect and seeking to minimize our AIC, we should proceed with a VAR(1) model.
