...
Since some of the series are cointegrated, we should be using a VAR specification that includes an error correction mechanism (vector error correction model) and alternative estimation methods to least squares (but not covered in class...).
...
```{r}
var = VAR(diff(ts_mts_train), p = 4, type = 'const')
